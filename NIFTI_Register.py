...
def make_rotx_parameters():
    ...
    f.write ('(FullSearchSpace1  "rotation_x" 0 -0.8 0.8 0.2)\n')
    f.write ('(FullSearchSpace2  "rotation_x" 0 -0.8 0.8 0.2)\n')     
    ...
    f.write ('(NumberOfFixedHistogramBins 32 64 64)\n')
    f.write ('(NumberOfMovingHistogramBins 32 64 64)\n')    
...
sform_code=int(hdr_fixed['sform_code'])
img.set_sform(affine_fixed, int(hdr_fixed['sform_code']))
img.set_qform(affine_fixed, int(hdr_fixed['qform_code']))
